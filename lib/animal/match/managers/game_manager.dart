...
import 'package:spelling_matching_game/animal/match/managers/audio_manager.dart';

class GameManager extends ChangeNotifier {
  Map<int, AnWord> tappedWords = {};
  bool canFlip = false,
      reverseFlip = false,
      ignoreTaps = false,
  ...
  tileTapped({required int index, required AnWord word}) {
    ignoreTaps = true;
