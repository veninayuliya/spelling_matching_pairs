...
import 'package:spelling_matching_game/transportation/match/managers/audio_manager.dart';
import 'package:spelling_matching_game/transportation/match/trword.dart';

class GameManager extends ChangeNotifier {
  Map<int, TrWord> tappedWords = {};
  bool canFlip = false,
      reverseFlip = false,
      ignoreTaps = false,
  ...
  tileTapped({required int index, required TrWord word}) {
    ignoreTaps = true;
